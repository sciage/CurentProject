...
public class GoogleSignHelp extends BaseActivity
  ...
  public GoogleSignHelp(FragmentActivity context, @Nullable String serverClientId,
      @NonNull GoogleAuthResponse listener) {
    mContext = context;
    mListener = listener;
